        ...
        if (time > 0.3f)
        {
            ...
            if (mousePos.x > Screen.width * 0.8f)
            {
                if (mousePos.y < Screen.height * 0.3f)
                {
                    ...
                    newObj.GetComponent<RectTransform>().localPosition = new Vector3(newObj.GetComponent<RectTransform>().localPosition.x, -5, newObj.GetComponent<RectTransform>().localPosition.z);
                    square.GetComponent<RectTransform>().localPosition = new Vector3(newObj.GetComponent<RectTransform>().localPosition.x, -4.5f, newObj.GetComponent<RectTransform>().localPosition.z);
                }
                else
                {
