...
public class infoCard : MonoBehaviour
{
    ...
    void OnMouseOver()
    {
        if (condi)
        {
            ...
            newObj.GetComponent<TextMeshPro>().text = Desc[name];
